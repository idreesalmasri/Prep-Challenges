...
// eval(obj.gradsList.join('+'))/obj.gradsList.length
// Resource:
...
function fullName(arr) {
   let reformattedArray= arr.map(obj=>obj.firstName+" " +obj.lastName);
...
function gradesAvg(arr) {
    // write your code here
    arr.map((obj)=>{
      let  avg=  eval(obj.gradsList.join('+'))/obj.gradsList.length;
      obj["avg"]=avg;
      })
      return arr;
}
